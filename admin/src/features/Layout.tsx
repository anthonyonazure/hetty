...
import SidebarModes from "lib/components/SidebarModes";
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List ref={navRef} sx={{ p: 0, flex: 1, overflowY: "auto", overflowX: "hidden" }}>
          ...
          <Link href="/dashboard" passHref>
            <ListItemButton key="dashboard" selected={page === Page.Dashboard}>
              <Tooltip title="Dashboard — stats & what's interesting">
                <ListItemIcon>
                  <DashboardIcon />
                </ListItemIcon>
              </Tooltip>
          ...
          <Link href="/cluster" passHref>
            <ListItemButton key="cluster" selected={page === Page.Cluster}>
              <Tooltip title="Distributed scanning across worker nodes">
                <ListItemIcon>
                  <LanIcon />
                </ListItemIcon>
              </Tooltip>
              <ListItemText primary="Distributed" />
            </ListItemButton>
          </Link>
